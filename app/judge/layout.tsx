...
const navigation = [
  ...
  { name: 'Teams', href: '/judge/teams', icon: Users },
  { name: 'Leaderboard', href: '/judge/leaderboard', icon: BarChart3 },
];
    ...
    <div className="min-h-screen bg-black text-white">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-[#333333]">
          <div className="flex items-center gap-3 mb-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-[#888888]">Evaluator</p>
            </div>
          </div>
          <Button
            variant="ghost"
      ...
      <div className="lg:pl-64">
        ...
        <header className="lg:hidden h-16 flex items-center justify-between px-4 border-b border-[#333333] bg-[#0a0a0a]">
          ...
          <span className="font-semibold">CryptX Judge</span>
          <div className="w-6" />
        </header>
